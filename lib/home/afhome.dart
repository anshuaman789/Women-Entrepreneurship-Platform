...
class AFHomePage extends StatefulWidget {
  @override
  AFHomePageState createState() => AFHomePageState();
}

class AFHomePageState extends State<AFHomePage> {
  @override
  bool _loggedIn =
          ...
          child: Row(
            ...
            children: [
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (value) {
                  if (value == 'logout') {
                    _logout(); // Call the logout method when logout is selected
                  }
                },
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(children: [
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        callClass(context, CommunityPage());
                                      },
                                      child: const Column(
                                        mainAxisAlignment:
