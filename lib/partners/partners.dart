...
//  var db = new MySql();
  ...
  Future<List<Map<String, dynamic>>> fetchImage(
    ...
    try {
      ...
      print("The error in fetchImage method is: " + e.toString());
...
////////////////////////////////////////////
  Future<List<Map<String, dynamic>>> fetchData(String endpointurl) async {
    List<Map<String, dynamic>> errorMsg = [
      {
        'organization': 'Failed to Get Data or Connection Failed!',
      },
    ];
    ...
    try {
      ...
      errorMsg[0]['error'] = e.toString();
      return List<Map<String, dynamic>>.from(
          errorMsg); //   List<Map<String, dynamic>>.from(parsedResponse);
    }
  }
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            left: 10.0, right: 8.0, bottom: 12.0),
                        child: Text(
                            ...
                            Container(
                              ...
                              child: (nofetch == false)
                                  ...
                                  : Padding(
                                      ...
                                      child: Text(
                                        "Network or Service failure. Please try again after some time.",
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: Colors.red,
                                        ),
